...
for fname in sorted(os.listdir(DATASET_DIR)):
    if fname.lower().endswith(('.jpg', '.jpeg', '.png')):
        # Ambil 4 digit angka dari filename
...
def get_best_waifu_match(face_img_array):
    ...
    return best_waifu, 1 - best_score  # similarity = 1 - cosine
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if label == 'saya' and confidence >= 60:
            ...
            cv2.putText(frame, f"Cocok dengan {best_waifu}", (x, y+h+20),
